...
export default function OfficersPage() {
  ...
  useEffect(() => {
    ...
    const subscription = supabase
      ...
      .on(
        "postgres_changes",
        { event: "*", schema: "public", table: "officiers" },
        () => {
          fetchOfficers();
        },
      )
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          date_debut_mandat: e.target.value,
                        })
                      }
                      required
                    />
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          date_fin_mandat: e.target.value,
                        })
                      }
                      required
                    />
                ...
                <Card key={officer.id}>
                  ...
                  <CardContent className="space-y-2">
                    <p className="text-sm">
                      ...
                      {officer.type === "conseil" ? "Conseil" : "Praesidium"}
                    </p>
                    <p className="text-sm">
                      <span className="text-muted-foreground">Début:</span>{" "}
                      {new Date(officer.date_debut_mandat).toLocaleDateString(
                        "fr-FR",
                      )}
                    </p>
                    <p className="text-sm">
                      <span className="text-muted-foreground">Fin:</span>{" "}
                      {new Date(officer.date_fin_mandat).toLocaleDateString(
                        "fr-FR",
                      )}
                    </p>
                    {officer.email && (
