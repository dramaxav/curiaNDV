...
export default function Zones() {
  ...
  const filteredZones = useMemo(() => {
    return zones.filter(zone =>
      ...
      zone.directeur_spirituel.toLowerCase().includes(searchTerm.toLowerCase())
    );
  }, [zones, searchTerm]);
  ...
  return (
    <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setFormData({...formData, contact_directeur: e.target.value})}
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Praesidia Total</CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Moyenne par Zone</CardTitle>
            <Church className="h-4 w-4 text-purple-500" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{Math.round(totalPraesidia / activeZones)}</div>
            <p className="text-xs text-muted-foreground">
