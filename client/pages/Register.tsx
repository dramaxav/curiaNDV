          ...
          <CardContent className="text-center space-y-4">
            <Alert>
              <AlertDescription>
                ...
                approuvée par les officiers du conseil. Ce processus peut
                prendre 2-3 jours ouvrables.
              </AlertDescription>
            </Alert>
          </CardContent>
          <CardFooter>
      ...
      <div className="w-full max-w-lg space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Remplissez ce formulaire pour demander l'accès. Votre demande sera
              examinée par les officiers du conseil.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="officier_praesidium">
                      Officier de Praesidium
                    </SelectItem>
                    <SelectItem value="officier_conseil">
                      Officier du Conseil
                    </SelectItem>
                  </SelectContent>
                </Select>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFormData({ ...formData, poste_souhaite: value })
                  }
                >
                  <SelectTrigger>
